...
% ======================================================================
    ...
    \begin{backgroundframe}[b]{art-hodel-1927-rigi}{0.0}{}
      \flushleft\alphabox{
        \textbf{\inserttitle}\\
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{sectionframe}{art-hodel-1927-rigi}{0.75}{Outline}
      \tableofcontents
      \footlineextra{Artwork: \href{http://gletschergarten.ch}{Hodel, 1927}.}
    \end{sectionframe}

    \begin{sectionframe}{art-hodel-1927-rigi}{0.75}{\insertsectionhead}
      \emph{Glacial erratics and glacial cycles.}
      \footlineextra{Artwork: \href{http://gletschergarten.ch}{Hodel, 1927}.}
    \end{sectionframe}

    \begin{backgroundframe}[t]{art-triner-1865-erdmannlistein}{0.0}{}
    ...
    \begin{backgroundframe}[t]{art-cole-1829-deluge}{0.0}{}
    ...
    \begin{backgroundframe}[b]{map-decharpentier-1841}{0.0}{}
      ...
      \footlineextra{Source: de Charpentier, 1841.}  %FIXME url
    \end{backgroundframe}
    ...
    \begin{frame}{Four glaciations in the Alps (1909)}
      ...
      \end{columns}
      \footlineextra{Source: Penck and Brückner, 1909; Preusser et al., 2011.}  %FIXME url
    \end{frame}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{frame}[t]{The evolution of total ice volume on land}
      \begin{columns}
        \column{30mm}
          \vspace{2.5mm}
          \uncover<1->{\includegraphics[width=30mm]{photo-morgane-foram-720p}}%
          \vspace{2.5mm}
          \uncover<2->{\includegraphics[width=30mm]{photo-csiro-bubbles-720p}}%
          \vspace{10.0mm}
        \column{90mm}
    ...
    \begin{frame}{Mechanisms of glacial cycles}
      \includegraphics[height=80mm]{hodell-2016-fig01}
      \footlineextra{Figure:
        \href{https://dx.doi.org/10.1126/science.aal4111}{Hodell, 2016.}}
    \end{frame}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{backgroundframe}[b]{art-hogard-1848-rhone}{0.0}{}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{backgroundframe}[t]{art-heer-1865-zurich}{0.0}{}
    ...
    \begin{frame}{Zürich after the glacial retreat}
      \begin{columns}
        \column{60mm}
          \includegraphics[width=\linewidth]{wild-2008-fig02}
        \column{60mm}
          \includegraphics[width=\linewidth]{wild-2008-fig06}
      \end{columns}
      \bigskip
      The Sihl River breached the moraine and built a delta in the lake.
      \footlineextra{Figure: Wagner, 2002.}  % FIXME url
    \end{frame}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{backgroundframe}[b]{map-coutterand-2017}{0.0}{}
      ...
      \footlineextra{Figure: Coutterand, 2017.}  % FIXME url
    \end{backgroundframe}
    ...
    \begin{frame}{Timing of the Last Glacial Maximum}
      \includegraphics[height=80mm]{map-wirsig-etal-2016}
      \footlineextra{Source: Wirsig et al., 2016.}  % FIXME url
    \end{frame}
...
% ----------------------------------------------------------------------
    ...
    \begin{sectionframe}{art-hodel-1927-rigi}{0.75}{Palaeo-glacier modelling}
...
%    \end{frame}
    ...
    \begin{frame}{Shallow approximations}
      \input{../figures/tex/pism-approximations}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{frame}[label=model-interfaces]{Parallel ice sheet model}
      \input{../figures/tex/pism-interfaces}\\
      \bigskip
         \begin{itemize}
           \only<1>{
...
%      \input{../figures/tex/pdd-snowfraction}\\
%      \begin{itemize}
...
%          \end{itemize}
%        \column{60mm}
%          \only<1-3>{\input{../figures/tex/pdd-annualcycle}}
%      \end{columns}
%    \end{frame}
...
%    \begin{sectionframe}{art-hodel-1927-rigi}{0.75}{Open questions}
%      \begin{enumerate}
...
%    \end{frame}
    ...
    \begin{sectionframe}{art-hodel-1927-rigi}{0.75}{Conclusions}
      \begin{itemize}
    ...
    \begin{backgroundframe}[b]{art-fearnley-1838-grindelwald}{0.0}{}
