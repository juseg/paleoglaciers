...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{backgroundframe}[t]{art/hogard-1848}{0.0}{}
    ...
    \begin{frame}{Zürich after the glacial retreat}
      \begin{columns}
        \begin{column}{.5\textwidth}\centering
          \includegraphics[width=\linewidth]{web/jaggin-2008-01}\\
          Deglaciation
        \end{column}
        \begin{column}{.5\textwidth}\centering
          \includegraphics[width=\linewidth]{web/jaggin-2008-05}\\
          XIVth century AD
        \end{column}
      \end{columns}
      \bigskip
